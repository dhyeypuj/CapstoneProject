        ...
        stage('Email Alert') {
            steps {
                ...
                emailext (
                    ...
                    to: "disha.sharma23@st.niituniversity.in, dhyey.pujara23@st.niituniversity.in, adwitiya.sinha23@st,niituniversity.in, akanksha.joshi23@st.niituniversity.in"
                )
            }
        }
    }
